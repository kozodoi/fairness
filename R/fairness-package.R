...
#'
#' The \strong{fairness} package offers various different metrics of algorithmic fairness. Fairness in machine learning is an emerging
...
#' by sex, gender, ethnicity, income, socioeconomic status, physical or mental disabilities), fair algorithms possess
...
#' subgroups. The package also offers convenient visualizations to help understand fairness metrics.
#'
#' @details
#' \tabular{ll}{
...
#' @author
#' \itemize{
#'  \item Nikita Kozodoi \email{nikita.kozodoi@@hu-berlin.de}
